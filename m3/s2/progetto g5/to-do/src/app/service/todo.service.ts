...
export class TodoService {
  ...
  getTodos(): Observable<iTodo[]> {
    return this.http.get<iTodo[]>('path/verso/todos.json');
  }

  updateTodoStatus(todoId: number, completed: boolean): Observable<iTodo> {
    const todoUpdateUrl = `api/todo/${todoId}/updateStatus`;
    return this.http.patch<iTodo>(todoUpdateUrl, { completed });
  }
