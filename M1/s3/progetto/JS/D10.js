...
*/
me.skills = ["JavaScript", "HTML", "CSS", "Cercare su Google"];
console.log("Le mie skill in fase di crescita :", me);
...
*/
me.skills.push("C++");
console.log("Da autodidatta ho appreso anche :", me);
...
*/
me.skills.pop("C++");
console.log("Ma non lo contiamo :", me);
...
let biggerNumber = whoIsBigger(10, 5);
console.log("Il numero maggiore è:", biggerNumber);
...
console.log(splitMe("Buongiorno buongiorno io sono luciano"));
...
console.log(deleteOne("Salve Salvino Vicino", true));
console.log(deleteOne("Salve Salvino Vicino", false));
...
const result = onlyLetters("Ho visto 3 porcellini");
console.log(result);
...
const daysElapsed = howManyDays("2023-10-14");
console.log("Numero di giorni trascorsi:", daysElapsed);
...
const isTodayMyBirthday = () => {
  ...
  const [birthMonth, birthDay] = birthdayInput.split('/').map(str => parseInt(str));
...
const checkBirthday = () => {
  ...
  if (isTodayMyBirthday()) {
      resultElement.textContent = "Auguri! Oggi è il tuo compleanno!";
  } else {
      resultElement.textContent = "Non è il tuo compleanno oggi.";
  }
}
...
console.log("Oggetto originale:", exampleObj);
const newObj = deleteProp(exampleObj, "age");
console.log("Oggetto senza l'età :", newObj);
...
*/
const searchByTitle = (title, movies) => {
...
*/
const searchAndDivide = (title, movies) => {
  const match = [];
  const unmatch = [];
