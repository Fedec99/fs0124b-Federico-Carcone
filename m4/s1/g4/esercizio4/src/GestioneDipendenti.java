public class GestioneDipendenti {
	...
	public static Dipendente[] istanziaDipendenti() {
		...
		arrayDipendenti[0] = new Dipendente("11111", Dipartimento.PRODUZIONE, Dipendente.stipendioBase, 40,
				Livello.OPERAIO);
		arrayDipendenti[1] = new Dipendente("22222", Dipartimento.PRODUZIONE, Dipendente.stipendioBase, 30,
				Livello.OPERAIO);
